...
// organizationResultEnvelope wraps the organization returned by create/update
// requests, which nest the organization under an "organization" key despite the
// documentation showing a flat object.
