...
type Computer struct {
	...
	RemoteAgentLastInventory time.Time `json:"RemoteAgentLastInventory,omitzero"`
	LastInventoryReceived    time.Time `json:"LastInventoryReceived,omitzero"`
	WindowsUpdateDate        time.Time `json:"WindowsUpdateDate,omitzero"`
	AntivirusDefinitionDate  time.Time `json:"AntivirusDefinitionDate,omitzero"`
	...
	AssetDate                time.Time `json:"AssetDate,omitzero"`
...
type ComputerPatchingStats struct {
	...
	LastSoftwareWindow        time.Time `json:"LastSoftwareWindow,omitzero"`
	NextSoftwareWindow        time.Time `json:"NextSoftwareWindow,omitzero"`
	LastPatchedDate           time.Time `json:"LastPatchedDate,omitzero"`
	LastMicrosoftPatchedDate  time.Time `json:"LastMicrosoftPatchedDate,omitzero"`
	LastThirdPartyPatchedDate time.Time `json:"LastThirdPartyPatchedDate,omitzero"`
